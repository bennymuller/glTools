...
class SkinClusterData(deformerData.MultiInfluenceDeformerData):
    ...
    def remapInfluence(self, oldInfluence, newInfluence):
        ...
        if not self._influenceData.has_key(oldInfluence):
            print ('No data stored for influence "' + oldInfluence + '" in skinCluster "' + self._data[
                'name'] + '"! Skipping...')
            return
        ...
        # Print message
        print('Remapped influence "' + oldInfluence + '" to "' + newInfluence + '" for skinCluster "' + self._data[
            'name'] + '"!')
    ...
    def combineInfluence(self, sourceInfluenceList, targetInfluence, removeSource=False):
        ...
        for i in range(len(sourceInfluenceList)):
            ...
            if not self._influenceData.has_key(sourceInfluenceList[i]):
                print('No data stored for influence "' + sourceInfluenceList[i] + '" in skinCluster "' + self._data[
                    'name'] + '"! Skipping...')
        ...
        for i in range(len(sourceInfluenceList)):
            ...
            if not i:
                ...
                if self._influenceData[sourceInfluence].has_key('polySmooth'):
                    self._influenceData[targetInfluence]['polySmooth'] = self._influenceData[sourceInfluence][
                        'polySmooth']
                else:
                ...
                if self._influenceData[sourceInfluence].has_key('nurbsSamples'):
                    self._influenceData[targetInfluence]['nurbsSamples'] = self._influenceData[sourceInfluence][
                        'nurbsSamples']
                else:
