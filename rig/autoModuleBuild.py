...
def checkModuleTemplate(moduleTemplateGrp, moduleType, moduleAttrs):
    ...
    # Check Module Type
    moduleTemplateType = cmds.getAttr(moduleTemplateGrp + '.moduleTemplate')
    ...
    for attr in moduleAttrs:
        if not cmds.attributeQuery(attr, n=moduleTemplateGrp, ex=True):
...
def moduleBuildAll():
    ...
    moduleTemplateList = cmds.ls('*.moduleTemplate', o=True)
...
def moduleBuild(moduleTemplateGrp):
    ...
    if not cmds.attributeQuery('moduleTemplate', n=moduleTemplateGrp, ex=True):
        raise Exception('Module template attribute "' + moduleTemplateGrp + '.moduleTemplate' + '" does not exist!')
    moduleType = cmds.getAttr(moduleTemplateGrp + '.moduleTemplate')
    ...
    # Build Module
    if moduleType == 'base':
        result = baseModuleBuild(moduleTemplateGrp)
    elif moduleType == 'fkChain':
        result = fkChainModuleBuild(moduleTemplateGrp)
    elif moduleType == 'ikChain':
        result = ikChainModuleBuild(moduleTemplateGrp)
...
def baseModuleBuild(moduleTemplateGrp):
    ...
    data = {}
    for attr in attrList: data[attr] = cmds.getAttr(moduleTemplateGrp + '.' + attr)
